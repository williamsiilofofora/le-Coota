    ...
    <div class="row container">
        ...
        <div class="card col-xl-4  mx-auto">
            ...
            <div class="card-footer">
                ...
                <button type="button" class="btn btn-primary lienmodal" data-toggle="modal" data-target="#concertId{{$events->id}}"data-id="{{$events->id}}" >
                    voir plus
                </button><br>
                <input type="hidden" name="concertId" value="{{$events->id}}">
...
<!-- Modal -->
        <div class="modal fade" id="concertId{{$events->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle"
            aria-hidden="true">
