<div class='container'>
    ...
    <div class="row ">
        ...
        <iframe name="cadeauyoutube" sandbox="allow-scripts" class="col-10 col-xl-4 mx-auto "
            src="{{$cadeaux->lien}}" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>
